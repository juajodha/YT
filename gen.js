function nameGen(type){
	  ...
	  tag24=Math.floor(Math.random()*tanda24.length);
          names=tanda20[tag20]+jp2[rnd]+tanda1[tag2]+jp1[rnd2]+tanda3[tag3]+tanda4[tag4]+tanda3[tag3]+tanda24[tag24];
        }
        else{
          rnd=Math.floor(Math.random()*jp2.length);
          rnd2=Math.floor(Math.random()*jp1.length);
	  ...
	  tag11=Math.floor(Math.random()*tanda11.length);
          names=us2[rnd]+tanda1[tag2]+tanda7[tag7]+tanda8[tag8]+tanda9[tag9]+tanda10[tag10]+tanda11[tag11]+tanda3[tag3]+us1[rnd2]+tanda3[tag3]+tanda5[tag5];
        }
          else{
	  ...
	  tag19=Math.floor(Math.random()*tanda19.length);
          names=tanda16[tag16]+de2[rnd]+"\n"+tanda1[tag2]+tanda14[tag14]+tanda18[tag18]+tanda19[tag19]+"\n"+tanda3[tag3]+tanda5[tag5]+de1[rnd2]+tanda2[tag1];
	}
        else{
          rnd=Math.floor(Math.random()*de2.length);
          rnd2=Math.floor(Math.random()*de1.length);
	  ...
	  tag6=Math.floor(Math.random()*tanda6.length);
          names=fr2[rnd]+tanda1[tag2]+fr1[rnd2]+tanda3[tag3]+tanda6[tag6]+tanda3[tag3]+tanda5[tag5];
	}
        else{
          rnd=Math.floor(Math.random()*fr2.length);
          rnd2=Math.floor(Math.random()*fr1.length);
	  ...
	  tag23=Math.floor(Math.random()*tanda23.length);
	  tag8=Math.floor(Math.random()*tanda8.length);
	  tag9=Math.floor(Math.random()*tanda9.length);
	  tag10=Math.floor(Math.random()*tanda10.length);
	  tag11=Math.floor(Math.random()*tanda11.length);
          names=tanda23[tag23]+it1[rnd]+"\n"+tanda8[tag8]+tanda9[tag9]+tanda10[tag10]+tanda11[tag11]+"\n"+tanda22[tag22]+it2[rnd]+"\n"+tanda21[tag21];
        }
        else{
          rnd=Math.floor(Math.random()*it2.length);
          rnd2=Math.floor(Math.random()*it1.length);
